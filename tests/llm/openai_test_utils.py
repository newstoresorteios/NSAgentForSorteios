...
_LEGACY_ASYNC_OPENAI_TARGETS = (
    ...
    "app.catalog.vision.product_image_index.AsyncOpenAI",
    "app.catalog.vision.image_product_id.AsyncOpenAI",
    "app.catalog.product_retrieval.AsyncOpenAI",
    "app.catalog.retrieval.specific.AsyncOpenAI",
    "app.catalog.category.resolver.AsyncOpenAI",
