...
def test_merge_tray_with_visual_prefers_nearest_family_sibling():
    from app.models import SalesInterpretation
    from app.catalog.vision.image_product_id import merge_tray_with_visual_neighbors
...
def test_soft_line_interpretation_strips_color_and_forces_recommend():
    from app.catalog.vision.image_product_id import soft_line_interpretation_from_identification
...
def test_dial_color_lock_rejects_amora_for_sealander_rosa():
    ...
    from app.catalog.vision.image_product_id import select_products_for_identified_dial
    from app.catalog.product_retrieval import (
...
def test_vision_prompt_uses_commercial_line_table():
