...
def _mock_matcher(
    ...
    *,
    ...
    monkeypatch.setattr("app.catalog.retrieval.runtime.get_settings", lambda: _settings())
...
async def test_exact_model_filters_unrelated_same_brand_candidates(monkeypatch):
    ...
    monkeypatch.setattr("app.catalog.retrieval.runtime.get_settings", lambda: _settings(api_key=""))
