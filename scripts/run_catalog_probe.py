...
def main():
    ...
    # Prior launch campaigns reserved USD 9.103398; this keeps total below USD 12.
    budget.update(campaign_id='launch-20260923-catalog-complete', max_cost_usd=2.89, max_calls=40)
