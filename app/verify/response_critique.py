...
async def apply_response_critique_loop(
    *,
    ...
    if mode is not None:
        ...
        from app.ops.rollout import resolve_effective_critique_mode
    ...
    from app.llm.llm_call_policy import resolve_turn_critique_mode
    ...
    from app.llm.llm_call_policy import should_run_llm_critique
