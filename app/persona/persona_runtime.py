...
class PersonaRuntimeConfig(BaseModel):
    ...
    def interpreter_policy_block(self) -> str:
        ...
        return (
            ...
            "- Atributos de catálogo (cor/material/movimento) NÃO contam como "
            "estilo de qualificação da persona — ainda falta estilo/ocasião "
            "ou faixa conforme as regras dela.\n"
...
def build_persona_runtime(
    *,
    ...
    from app.persona.persona_knowledge_repository import chatbo_persona_id
