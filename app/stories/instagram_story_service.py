...
from app.verify.fact_authority import authorize_products_for_responder, catalog_item_key_for
...
from app.identity.request_principal import RequestPrincipal, principal_from_internal
...
def _story_store_url(
    ...
    from app.stories.story_product_matcher import extract_store_product_url
...
def _matched_product_conflicts_with_vision(
    ...
    if not product or analysis is None:
        return False
    from app.stories.story_match_decider import _VARIANT_MARKERS, build_evidence_profile, _fold
...
async def _hydrate_story_media(story: InstagramStoryContext) -> InstagramStoryContext:
    ...
    from app.channels.meta_instagram import fetch_instagram_media_graph
