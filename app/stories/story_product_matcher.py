...
from app.stories.story_match_decider import rerank_candidates_with_consensus, try_resolve_tied_candidates
...
def tray_search_plan(analysis: StoryVisualUnderstanding) -> tuple[str | None, list[str]]:
    ...
    for text in analysis.visible_text or []:
        ...
        if _is_sku_like(raw):
            _add_phrase(raw)
            continue
        from app.stories.story_match_decider import _is_brand_only_line
...
def build_storefront_fallback_queries(
    ...
    *,
    ...
    from app.stories.story_match_decider import model_line_search_tokens
...
def _title_lines_for_search(analysis: StoryVisualUnderstanding) -> list[str]:
    from app.stories.story_match_decider import _title_like_lines
    ...
    def _ingest_tray_page(
        *,
        ...
        for idx, product in enumerate(products):
            ...
            from app.stories.story_match_decider import _SIZE_RE, _listing_case_size_mm
