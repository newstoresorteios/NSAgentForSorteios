...
def preference_gender_tokens(interpretation: SalesInterpretation) -> tuple[str, ...]:
    ...
    from app.catalog.preference_normalize import gender_search_aliases, preference_gender_label
...
async def resolve_products_from_message_text(
    ...
    *,
    ...
    from app.catalog.catalog_specs import reference_from_store_url
    from app.config import get_settings
...
class ProductRetrievalCompiler:
    ...
    def compile(
        ...
        *,
        ...
        subject = interpretation.subject
        from app.catalog.preference_normalize import is_gender_only_label
...
def hard_filter_products(
    ...
    *,
    ...
    hard_material = None
    try:
        from app.catalog.catalog_index import _hard_constraints_from_interpretation
    ...
    try:
        from app.catalog.catalog_specs import message_wants_chronograph
