...
from app.catalog.index.product_fields import (
    listed_promotional_price,
    product_id_of,
    snapshot_list_price,
)
from app.catalog.retrieval.price import money_decimal
...
def product_dict_to_snapshot(
    ...
    *,
    ...
    return ProductSnapshot(
        ...
        price=_money(snapshot_list_price(payload)),
        promotional_price=_money(listed_promotional_price(payload)),
