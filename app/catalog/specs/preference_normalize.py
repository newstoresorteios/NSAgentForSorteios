...
def repair_specific_model_tokens(
    ...
    *,
    ...
    try:
        ...
        log_swallowed("specs.case_size_range", exc)
    if mm_match:
...
def normalize_sales_interpretation(
    ...
    *,
    ...
    Name/city/urgency replay stays in ``sales_agent._hydrate_sales_interpretation``.
    ...
    try:
        ...
        log_swallowed("specs.identity_lock", exc)
    ...
    try:
        ...
        log_swallowed("specs.catalog_spec_repair", exc)
